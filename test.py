...
page = st.sidebar.radio("Go to", ["Preprocessing & Training", "Detector", "Train Model"])
...
if page == "Preprocessing & Training":
    ...
    st.title("Train AI Text Detection Model")
    processed_file = "processed_dataset.xlsx"
    ...
    if os.path.exists(processed_file):
        ...
        st.write("No processed dataset found. Please preprocess the data first.")
